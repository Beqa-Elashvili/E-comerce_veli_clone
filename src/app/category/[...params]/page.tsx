  ...
  return (
    <div className="w-full">
      <div className="flex gap-20">
        ...
        <div className="w-full">
          <div className="grid grid-cols-4 pb-4 w-full justify-between gap-2 gap-y-4">
            {name && !name2 && (
              <>
                {products?.children.map((children: Item) =>
                  children.Product.map((product: Product) => {
                    return (
                      <div key={product.id} className="px-2 z-0">
                        ...
                        >
                          ...
                          <div className="hover:bg-gray-100 overflow-hidden rounded-lg">
                            <p className="text-balance py-2">{product.name}</p>
                            <img
